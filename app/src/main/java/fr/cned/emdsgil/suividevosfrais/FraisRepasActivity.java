...
/**
 * Created by Florent on 16/02/2018.
 */

public class FraisRepasActivity extends AppCompatActivity {
    ...
    private void cmdValider_clic() {
        findViewById(R.id.cmdRepasValider).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Serializer.serialize(Global.listFraisMois, FraisRepasActivity.this) ;
                retourActivityPrincipale() ;
            }
        }) ;
    }
    ...
    private void retourActivityPrincipale() {
        Intent intent = new Intent(FraisRepasActivity.this, MainActivity.class) ;
